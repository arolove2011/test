...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Bumper, function (sprite, otherSprite) {
    if (sprite.vy > 0 && !(sprite.isHittingTile(CollisionDirection.Bottom)) || sprite.y < otherSprite.top) {
        ...
        info.changeLifeBy(-1)
        sprite.say("Oh my god!", invincibilityPeriod)
...
function giveIntroduction () {
    game.setDialogFrame(img`
        99cccccccccccccccccccc99
        9ccbbbbbbbbbbbbbbbbbbcc9
        ccbbb11111111111111bbbcc
        cbbb1111111111111111bbbc
        cbbb1111111111111111bbbc
        cbbb1111111111111111bbbc
        cbbb1111111111111111bbbc
        cbbb1111111111111111bbbc
...
function initializeCoinAnimation () {
    coinAnimation = animation.createAnimation(ActionKind.Idle, 100)
...
function initializeFlierAnimations () {
    flierFlying = animation.createAnimation(ActionKind.Flying, 150)
    flierFlying.addAnimationFrame(img`
        ...
        . f . f 4 4 4 f 4 f 4 4 4 f . f 
        . f f 4 4 4 4 4 4 4 4 4 4 4 f f 
        . f 4 4 4 4 4 f 4 f 4 4 4 4 4 f 
        . f 4 4 4 4 4 f 4 f 4 4 4 4 4 f 
        . f f 4 4 4 4 4 5 4 4 4 4 4 f f 
    ...
    flierFlying.addAnimationFrame(img`
        ...
        . . . . f 4 4 4 4 4 4 4 f . . . 
        . . . f 4 f f 4 4 4 f f 4 f . . 
        . . . f 4 4 4 f 4 f 4 4 4 f . . 
        . . f 4 4 4 4 4 4 4 4 4 4 4 f . 
        . . f 4 4 4 4 f 4 f 4 4 4 4 f . 
        . f 4 4 4 4 4 f 4 f 4 4 4 4 4 f 
        . f 4 4 4 4 4 4 5 4 4 4 4 4 4 f 
        . f 4 f 4 4 4 4 4 4 4 4 4 f 4 f 
    ...
    flierFlying.addAnimationFrame(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)
    flierIdle = animation.createAnimation(ActionKind.Idle, 150)
...
function animateRun () {
    mainRunLeft = animation.createAnimation(ActionKind.RunningLeft, 150)
    ...
    mainRunLeft.addAnimationFrame(img`
        ...
        . f f f f . f f f . . . . . . . 
        `)
    mainRunRight = animation.createAnimation(ActionKind.RunningRight, 150)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`tile1`, function (sprite, location) {
    ...
    currentLevel += 1
    if (hasNextLevel()) {
        game.splash("Good! Go to next level!")
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Flier, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    sprite.say("Oh my god!", invincibilityPeriod * 1.5)
    music.powerDown.play()
